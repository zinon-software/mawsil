          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(image: AssetImage("assets/image/food.jpg"),
                  fit: BoxFit.cover,),
              ),
            ), // text container
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.only(
                    bottomRight: Radius.circular(Dimensions.heightDynamic(20)),
                    topRight: Radius.circular(Dimensions.heightDynamic(20)),
                  ),
                  color: Colors.white,
                ),
                child: Padding(
                  padding:  EdgeInsets.only(left: Dimensions.heightDynamic(10), right: Dimensions.heightDynamic(10)),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    mainAxisAlignment: MainAxisAlignment.center,
                    children:  [
                      BigText(text: "Nutritious fruit meal is china",),
