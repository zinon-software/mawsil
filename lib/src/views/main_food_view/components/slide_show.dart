      ...
      children: [
        GetBuilder<PopularProductController>(
          builder: (popularProducts) {
            return !popularProducts.isLoaded? CircularProgressIndicator(color: AppColors.mainColor,) : SizedBox(
              height: Dimensions.widthDynamic(300),
              child: PageView.builder(
                controller: pageController,
                itemCount: popularProducts.popularProductList.length,
                itemBuilder: (BuildContext context, int position) =>
                    _buildPageItem(position, popularProducts.popularProductList[position]),
              ),
            );
          }
        ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(Dimensions.heightDynamic(30)),
              image: DecorationImage(image: NetworkImage(popularProductList.img!),
          ...
          Align(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: AppColumn(popularProductList: popularProductList,)
              ),
            ),
          ),
        ],
